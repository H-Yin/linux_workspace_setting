...
c.NotebookApp.certfile = os.environ['HOME'] + '/.jupyter/cert.pem'
...
c.NotebookApp.keyfile = os.environ['HOME'] + '/.jupyter/cert.key'
...
c.NotebookApp.password = 'sha1:db6bcfc17948:d31c0f65588db45dc83fb4d7a769f80b3046584b'
